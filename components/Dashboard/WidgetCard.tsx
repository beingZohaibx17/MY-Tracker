...
export const WidgetCard: React.FC<WidgetCardProps> = ({ 
  ...
  return (
    ...
    >
      ...
      {/* Interactive Glow */}
      <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-1000 ease-out bg-gradient-to-br from-${baseColor}-500 via-transparent to-transparent`}></div>
      <div className={`absolute -right-24 -top-24 w-72 h-72 rounded-full bg-${baseColor}-500/10 blur-[100px] transition-all duration-1000 group-hover:bg-${baseColor}-500/20 group-hover:scale-125`}></div>
      <div className={`absolute -left-24 -bottom-24 w-72 h-72 rounded-full bg-${baseColor}-500/5 blur-[80px] transition-all duration-1000 group-hover:bg-${baseColor}-500/10 group-hover:scale-110`}></div>
